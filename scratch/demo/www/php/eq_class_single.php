<?php
	...
	$query_cols = array('cr_id', 'name', 'all_names', 'bottomLine', 'brand', 'description', 'displayName', 'highs', 'lows', 'rating_descriptions', 'rating_names', 'review', 'spec_descriptions', 'spec_names', 'summary');
	$query_cols = array('cr_id', 'name', 'all_names', 'bottomLine', 'brand', 'description', 'displayName', 'highs', 'lows', 'review', 'summary');
...
//	$posted_vars = filter_non_null($posted_vars);
	...
	$sql = get_custom_query($conn, $TABLE_NAME, $query, $query_cols, array('name', 'image_url', 'prod_ids'));
